...
Zap Pilot 是一個鏈上投資組合自動駕駛系統。對於繁忙的 DeFi 用户，Zap
...
| 類別                 | % 分配 | 備註                                       |
| -------------------- | ------ | ------------------------------------------ |
| 用户空投（Zap 分數） | 40%    | 基於使用情況、推薦、社交互動               |
| 團隊                 | 20%    | 1 年鎖定期 + 2 年線性解鎖                  |
| 合作伙伴和顧問       | 10%    | 包括孵化器（1–2%）、發射台（1–2%）、KOL 池 |
| DAO 庫               | 20%    | 回購、激勵活動、治理                       |
| 流動性引導           | 10%    | Uniswap/Aerodrome LP 種子                  |

🔒 **合作伙伴/顧問解鎖：** 代幣根據貢獻類型解鎖，通常使用 6 個月鎖定期 +
...
| 分數追蹤           | Notion / Airtable / Firebase             | 鏈下用户分析         |
| 空投工具           | ThirdWeb SDK / Galxe / Airdrop.so        | 代幣分發工具         |
| 流動性提供和發射台 | Uniswap / Aerodrome / 合作 IDO           | 流動性和發射合作伙伴 |
...
| **智能 EOA 錢包基礎設施** | 為終端用户提供無縫體驗，增強錢包體驗 |
